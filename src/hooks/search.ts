...
export default function<T>(search: SearchFunction<T>, history: History, pageSize: number): HookReturns<T> {
  ...
  return { items, total, loading, query, page, setQuery, setPage };
}
